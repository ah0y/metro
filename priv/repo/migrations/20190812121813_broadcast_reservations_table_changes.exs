defmodule Metro.Repo.Migrations.BroadcastReservationsTableChanges do
  use Ecto.Migration
...
#      $$ LANGUAGE plpgsql;"
    ...
    execute "
      CREATE TRIGGER notify_reservation_changes_trigger
  ...
  def down do
    execute "DROP TRIGGER notify_reservation_changes_trigger"
  end
end
